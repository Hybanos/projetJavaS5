...
public class RegistresMF {
    ...
    */
    ...
    public static Map<Integer, Consommable> genererConsomable() {
        ...
        map.put(3, new Consommable("Petite potion de soin", "Une simple pomme de terre crue, elle a l'air mangeable", 3, 0));
        map.put(4, new Consommable("Carotte", "Cette carotte, bien que crue, a l'air apétissante", 1, 0));
        map.put(5, new Consommable("Patate", "Une petite potion qui régénère un peu de vie", 1, 0));
